...
test_that("{shinytest2} recording: launch_test", {
  app <- AppDriver$new(name = "launch_test", height = 736, width = 1169, loadTimeout = 2e+05)
...
test_that("{shinytest2} recording: slider_button_test", {
  app <- AppDriver$new(name = "slider_button_test", height = 736, width = 1169, loadTimeout = 2e+05)
  app$set_inputs(DataTables_Table_0_length = "10")
...
test_that("{shinytest2} recording: testing_selection_box", {
  app <- AppDriver$new(name = "testing_selection_box", height = 736, width = 1169, loadTimeout = 2e+05)
  app$set_inputs(DataTables_Table_0_length = "10")
